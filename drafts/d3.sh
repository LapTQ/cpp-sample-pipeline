g++ \
  ...
  -lonnxruntime \
  -I/Users/user/Downloads/cpp-sample-pipeline/libs/yolov8onnx/latest/source \
  -lopencv_dnn \
  -std=c++17 \
  ...
  /Users/user/Downloads/cpp-sample-pipeline/libs/yolov8onnx/latest/source/inference.cpp
